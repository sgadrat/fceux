...
TOESP_MSG_FILE_GET_LIST = 23          ; Get list of existing files in a path
TOESP_MSG_FILE_GET_FREE_ID = 24       ; Get an unexisting file ID in a specific path
...
FROMESP_MSG_FILE_ID = 5               ; Returns a free file ID (FILE_GET_FREE_ID)
