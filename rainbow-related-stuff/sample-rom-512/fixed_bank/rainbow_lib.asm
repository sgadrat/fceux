...
FROMESP_MSG_WIFI_STATUS = 7           ; Returns WiFi connection status
FROMESP_MSG_SERVER_STATUS = 8         ; Returns server connection status
FROMESP_MSG_HOST_SETTINGS = 9         ; Returns server settings (host name + port)
FROMESP_MSG_RND_BYTE = 10             ; Returns random byte value
FROMESP_MSG_RND_WORD = 11             ; Returns random word value
