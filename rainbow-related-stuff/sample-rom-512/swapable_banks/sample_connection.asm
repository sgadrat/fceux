SAMPLE_CONNECTION_BANK = CURRENT_BANK_NUMBER
...
sample_connection_wifi_state = $0400
sample_connection_server_state = $0401

sample_connection_switch_connection:
.(
	lda sample_connection_server_state
	bne disconnect
...
.(
	...
	green:              ;
		lda #1          ;
	store_state:
	sta sample_connection_wifi_state
	...
	lda $5000                          ; Fetch ESP response
	sta sample_connection_server_state ;
	...
	lda sample_connection_wifi_state
	clc
	adc #1
